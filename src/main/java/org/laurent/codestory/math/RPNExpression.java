...
class RPNExpression implements Calculable {
	...
	public RPNExpression(List<Token> tokens, String expression, final Map<String, BigDecimal> variables) {
		super();
		this.tokens = tokens;
	 ...
	 */
	public BigDecimal calculate(BigDecimal... values) throws IllegalArgumentException {
		...
		final Stack<BigDecimal> stack = new Stack<BigDecimal>();
